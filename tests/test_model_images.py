...
def test_getImage_valid(params):
...
def test_getImage_no_id(params):
    model_catalog, model_id = params
...
def test_getImage_invalid_id_format(params):
    model_catalog, model_id = params
    with pytest.raises(Exception) as excinfo:
...
def test_getImage_invalid_id_value(params):
    model_catalog, model_id = params
    with pytest.raises(Exception) as excinfo:
...
def test_listImages_valid_id(params):
    model_catalog, model_id = params
...
def test_listImages_valid_alias(params):
    model_catalog, model_id = params
    model = model_catalog.get_model(model_id=model_id)
...
def test_listImages_no_id(params):
    model_catalog, model_id = params
    with pytest.raises(Exception) as excinfo:
...
def test_listImages_invalid_id_format(params):
    model_catalog, model_id = params
    with pytest.raises(Exception) as excinfo:
...
def test_listImages_invalid_id_value(params):
    model_catalog, model_id = params
    with pytest.raises(Exception) as excinfo:
...
def test_addImage_valid_duplicate(params):
    model_catalog, model_id = params
    model_image_id = model_catalog.add_model_image(model_id=model_id,
                                                url="http://www.neuron.yale.edu/neuron/sites/default/themes/xchameleon/logo.png",
...
def test_editImage_url_valid(params):
    model_catalog, model_id = params
    model = model_catalog.get_model(model_id=model_id)
...
def test_editImage_no_id(params):
    model_catalog, model_id = params
    with pytest.raises(Exception) as excinfo:
...
def test_editImage_invalid_id_format(params):
    model_catalog, model_id = params
    with pytest.raises(Exception) as excinfo:
...
def test_editImage_invalid_id_value(params):
    model_catalog, model_id = params
    with pytest.raises(Exception) as excinfo:
