...
def test_getInstance_valid_id(params):
...
def test_getInstance_valid_model_version(params):
    model_catalog, model_id = params
    model = model_catalog.get_model(model_id=model_id)
...
def test_getInstance_valid_alias_version(params):
    model_catalog, model_id = params
    model = model_catalog.get_model(model_id=model_id)
...
def test_getInstance_invalid_only_model(params):
    model_catalog, model_id = params
...
def test_getInstance_invalid_only_alias(params):
    model_catalog, model_id = params
    model = model_catalog.get_model(model_id=model_id)
    with pytest.raises(Exception) as excinfo:
...
def test_getInstance_invalid_only_version(params):
    model_catalog, model_id = params
    model = model_catalog.get_model(model_id=model_id)
    with pytest.raises(Exception) as excinfo:
...
def test_listInstances_valid_model_version(params):
    model_catalog, model_id = params
    model = model_catalog.get_model(model_id=model_id)
...
def test_listInstances_valid_alias_version(params):
    model_catalog, model_id = params
    model = model_catalog.get_model(model_id=model_id)
...
def test_listInstances_invalid_noInput(params):
    model_catalog, model_id = params
    with pytest.raises(Exception) as excinfo:
...
def test_editInstance_valid_id(params):
    model_catalog, model_id = params
    model = model_catalog.get_model(model_id=model_id)
...
def test_editInstance_valid_model_version(params):
    model_catalog, model_id = params
    model = model_catalog.get_model(model_id=model_id)
...
@pytest.mark.xfail
def test_editInstance_valid_alias_version(params):
    model_catalog, model_id = params
    model = model_catalog.get_model(model_id=model_id)
...
def test_editInstance_invalid_only_model(params):
    model_catalog, model_id = params
    with pytest.raises(Exception) as excinfo:
...
def test_editInstance_invalid_only_alias(params):
    model_catalog, model_id = params
    model = model_catalog.get_model(model_id=model_id)
    with pytest.raises(Exception) as excinfo:
...
def test_editInstance_invalid_only_version(params):
    model_catalog, model_id = params
    model = model_catalog.get_model(model_id=model_id)
    with pytest.raises(Exception) as excinfo:
...
def test_editInstance_valid_change_version(params):
    model_catalog, model_id = params
    model = model_catalog.get_model(model_id=model_id)
...
def test_downloadInstance_valid_id_cscs(params):
    model_catalog, model_id = params
...
def test_downloadInstance_valid_id_collab(params):
    model_catalog, model_id = params
...
def test_downloadInstance_valid_id_directory(params):
    model_catalog, model_id = params
    model_instance = model_catalog.get_model_instance(model_id=model_id, version="2.0a")
...
def test_downloadInstance_valid_alias_version(params):
    model_catalog, model_id = params
    model = model_catalog.get_model(model_id=model_id)
...
def test_findCreateInstance_valid_exist_instance_id(params):
    class testModel:
...
def test_findCreateInstance_valid_create(params):
    class testModel:
        def __init__(self, model_uuid="", model_version=""):
            self.model_uuid = model_uuid
            self.model_version = model_version
